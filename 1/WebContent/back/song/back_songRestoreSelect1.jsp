...
<title>后台用户删除其相关的评论</title>
<script type="text/javascript">
function deleteForm(id){
if(confirm("确定要删除此回复吗？")){
window.location.href="SongSerlvet?method=8&id="+id;//传递idd这篇文章的id是为了删除此回复后继续返回到此文章相应的回复页面
}
}
</script>
</head>
...
List list=null;
if(str==null){
	list=songResoreDao.queryRestore(consumerForm1.getId().toString());
...
<tr>
 ...
 <%
   ...
   %>
   <tr bgcolor="#FFFFFF">
   				<td><div align="center"><%=songDao.selectsongName(songrestoreForm.getSongId()) %></div></td>
              ...
              <td><div align="center"><a href="javascript:deleteForm('<%=songrestoreForm.getId()%>')">删除</a></div></td>
   </tr>  
   <%} %>
</table>

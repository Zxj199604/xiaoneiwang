...
if(confirm("确定要删除此歌曲类别的信息吗？")){
window.location.href="SongSerlvet?method=1&id="+id;
}
}
</script>
</head>
...
List list=null;
if(str==null){
	list=songTypeDao.querySongType();
...
if(pagination.getRecordSize()<=0){
	out.println("<p align=center><img src=/1/images/icon.gif width=10 height=10>&nbsp;&nbsp;&nbsp;&nbsp;没有歌曲类别！</p>");
	%>
	<table width="399" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><div align="right"><a href="back_songTypeAdd.jsp">添加</a></div></td>
                        </tr>
    </table>
	<%} else{out.print("<p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=/1/images/icon.gif width=10 height=10>&nbsp;&nbsp;歌曲类别查询</p>");
	%>
    ...
    <table width="486" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#ACD6FF">
         ...
         %>   
            <tr bgcolor="#FFFFFF">
              <td height="20"><div align="center"><%=songTypeForm.getTypeName()%></div></td>
              <td><div align="center"><a href="javascript:deleteForm('<%=songTypeForm.getId()%>')">删除</a></div></td>
            </tr>       
        <%} %>
        </table> 

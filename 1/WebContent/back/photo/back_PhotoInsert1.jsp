...
<table width="800" border="0" align="center" cellpadding="0"
		...
		<tr>
						...
						<table width="573" border="0" cellpadding="0" cellspacing="0" background="/1/images/back_picture/back_noword_05.jpg">
							...
							<td valign="top" align="center">	
							 <%out.println("<p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=/1/images/icon.gif width=10 height=10>&nbsp;&nbsp;照片上传</p>");
		  						%>
								 <form action="PhotoSerlvet?method=2" method="post"  name="form" onSubmit="return addPhoto()" enctype="multipart/form-data">
			...
			out.print(request.getAttribute("result"));
			  ...
			  <%out.println("<p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=/1/images/icon.gif width=10 height=10>&nbsp;&nbsp;<a href='back_VideoInsert1.jsp'>添加视频</a></p>");
		  %>
							</td>
							</tr>
						</table>

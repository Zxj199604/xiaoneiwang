...
List list=null;
if(str==null){
	list=photoDao.queryPhoto(consumerForm1.getId().toString());
		...
		<tr>
			<td width="227" valign="top"><jsp:include page="../back_Left1.jsp"
				...
				<!-- 第二列 -->	
          		...
          		+"&nbsp;&nbsp;&nbsp;&nbsp;<img src=/1/images/icon.gif width=10 height=10>&nbsp;&nbsp;<a href='back_VideoSelect1.jsp'>视频删除</a></p>");
...
<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="20"><div align="center"><a href="PhotoSerlvet?method=3&id=<%=photoForm.getId()%>">删除</a></div></td>
                    </tr>
</table>
</div>
</td>

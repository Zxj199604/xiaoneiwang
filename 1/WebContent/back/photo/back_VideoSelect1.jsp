...
window.location.href="VideoSerlvet?method=3&id="+id;
}
}
</script>
</head>
...
List list=null;
if(str==null){
	list=videoDao.queryVideo(consumerForm1.getId().toString());
...
if(pagination.getRecordSize()<=0){
	out.println("<p align=center><img src=/1/images/icon.gif width=10 height=10>&nbsp;&nbsp;&nbsp;&nbsp;没有视频信息查询！</p>");
		  ...
		  out.print("<p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=/1/images/icon.gif width=10 height=10>&nbsp;&nbsp;视频查询"
				  +"&nbsp;&nbsp;&nbsp;&nbsp;<img src=/1/images/icon.gif width=10 height=10>&nbsp;&nbsp;<a href='back_	PhotoSelect1.jsp'>照片删除</a></p>");%>

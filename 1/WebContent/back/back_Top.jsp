...
<table width="800" height="65" border="0" align="center" cellpadding="0" cellspacing="0" background="/1/images/back_picture/back_noword_01.jpg">
  <tr>
    <td width="500">&nbsp;</td>
    <td width="299"><p>&nbsp;</p>
    <p><a href="/1/head/head_main.jsp" class="backTop">返回首页</a>&nbsp;<font color="#FFFFFF">|</font>&nbsp; <a href="/1/back/backMainPage1.jsp" class="backTop">管理信息</a>&nbsp;<font color="#FFFFFF">|</font>&nbsp; <a href="/1/dealwith.jsp?sign=2" class="backTop">安全退出</a>&nbsp;<font color="#FFFFFF"></font>&nbsp; &nbsp;&nbsp;</p></td>
  </tr>
</table>

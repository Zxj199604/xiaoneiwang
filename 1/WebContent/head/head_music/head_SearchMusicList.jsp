...
String leixin=request.getParameter("leixing");
  String str=(String)request.getParameter("Page");
  int Page=1;
  List songList=null;
  if(str==null){
	  songList=songDao.manyquresong(leixin, message);
 ...
 %>
			...
			<tr>
				...
				<tr>
						...
						<a href="SongSerlvet?id=<%=songForm.getId()%>"><img alt="试听" src="/1/images/head_picture/tryListen.gif" style="width: 20px;height: 20px;" ></a>&nbsp;|&nbsp;
						<a href=""><img alt="下载" src="/1/images/head_picture/down.png" style="width: 20px;height: 20px;"></a>
						...
						<td height="17" class="head-02"><a
							href="head_ArticleForm.jsp?id=<%=songForm.getId()%>"
...
<%
 ...
 %>
 <%=pagination.printCtrl4(Page, leixin, message) %>
</td>
